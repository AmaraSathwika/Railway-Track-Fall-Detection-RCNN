...
The system detects faulty regions, highlights defects using **bounding boxes**, and triggers an **immediate alert message with siren sound** when a defect is identified. This approach enhances railway infrastructure safety and reduces reliance on manual inspection.
...
Images are preprocessed using resizing, normalization, and data augmentation techniques to improve model robustness and detection accuracy under different environmental conditions.
...
A major highlight of this project is the **alert mechanism**.
...
A Flask-based web application is developed to provide an interactive interface for railway track monitoring. The application allows users to:
